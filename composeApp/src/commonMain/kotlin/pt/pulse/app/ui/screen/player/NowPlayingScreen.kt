...
package pt.pulse.app.ui.screen.player
...
import pt.pulse.app.extension.GradientAngle
import pt.pulse.app.extension.GradientOffset
import pt.pulse.app.extension.KeepScreenOn
import pt.pulse.app.extension.getColorFromPalette
import pt.pulse.app.extension.hsvToColor
import pt.pulse.app.extension.rememberIsInPipMode
import pt.pulse.app.ui.component.AddToPlaylistModalBottomSheet
import pt.pulse.app.ui.component.FullscreenLyricsSheet
import pt.pulse.app.ui.component.InfoPlayerBottomSheet
...
import pt.pulse.app.ui.screen.player.content.NowPlayingContentAppleMusic
import pt.pulse.app.ui.screen.player.content.NowPlayingContentM3Expressive
import pt.pulse.app.ui.screen.player.content.NowPlayingContentSpotify
import pt.pulse.app.ui.screen.player.content.NowPlayingContentState
import pt.pulse.app.ui.screen.player.content.PlayerBackdropColor
import pt.pulse.app.ui.screen.player.content.toAudioCodecLabel
...
fun NowPlayingScreenContent(
    ...
    if (showVoteDialog) {
        val canVoteLyrics =
            screenDataState.lyricsData?.lyricsProvider == LyricsProvider.PULSE &&
                screenDataState.lyricsData
                    ?.lyrics
                    ?.pulseLyrics != null
        val canVoteTranslatedLyrics =
            screenDataState.lyricsData?.translatedLyrics?.second == LyricsProvider.PULSE &&
                screenDataState.lyricsData
                    ?.translatedLyrics
                    ?.first
                    ?.pulseLyrics != null
