...
import pt.pulse.app.expect.ui.PlatformWebView
import pt.pulse.app.expect.ui.createWebViewCookieManager
...
import pulse.composeapp.generated.resources.log_in
import pulse.composeapp.generated.resources.login_failed
    ...
    LaunchedEffect(state) {
        snapshotFlow { state.value }.collect {
            Logger.d(
                ...
                "WebViewState: ${
                    when (it) {
                        is pt.pulse.app.expect.ui.WebViewState.Finished -> "Finished"
                        is pt.pulse.app.expect.ui.WebViewState.Loading -> "Loading ${it.progress}%"
                    }
                }",
            )
        }
