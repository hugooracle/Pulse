...
import pulse.composeapp.generated.resources.lastfm_login_step_1
import pulse.composeapp.generated.resources.lastfm_login_step_2
import pulse.composeapp.generated.resources.lastfm_open_authorize_page
import pulse.composeapp.generated.resources.lastfm_paste_callback_confirm
import pulse.composeapp.generated.resources.lastfm_paste_callback_hint
import pulse.composeapp.generated.resources.lastfm_paste_callback_title
...
/**
 * Last.fm's desktop auth flow, which is what Pulse uses on every platform.
 *
 * There is no WebView here on purpose — unlike the Discord and Spotify screens, this never sees the
 * user's password. Pulse asks Last.fm for a request token, sends the user to Last.fm's own page
