package pt.pulse.app.ui.navigation.destination.home
 ...
 * and would let a deep link ask for a year with no [pt.pulse.core.domain.data.entities.analytics.PlaybackEventEntity]
 * rows behind it.
 */
@Serializable
