package pt.pulse.service.lyrics

import pt.pulse.core.ktorext.crypto.Hmac
import pt.pulse.core.ktorext.crypto.HmacUri
...
import pt.pulse.service.lyrics.am.parseAMHlsVariants
import pt.pulse.service.lyrics.am.pickAMRendition
import pt.pulse.service.lyrics.am.AMArtistResource
import pt.pulse.service.lyrics.am.AMSearchResponse
...
import pt.pulse.service.lyrics.models.response.BaseResponse
import pt.pulse.service.lyrics.models.response.BetterLyricsResponse
import pt.pulse.service.lyrics.models.response.LrclibObject
...
private const val TAG = "PulseLyricsClient"

class PulseLyricsClient {
    private val algorithm = ""

    private val hmacService = Hmac("HmacSHA256", "pulse-lyrics")
    private val lyricsService = PulseLyrics()
