 ...
 * (MetrolistGroup/metroserver, GPL-3.0 — the same licence as this project) so that Pulse
 ...
 */
package pt.pulse.service.listentogether
...
class ListenTogetherClient(
    ...
    companion object {
         ...
         * makes Pulse interoperable out of the box.
         */
