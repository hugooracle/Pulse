...
import pt.pulse.core.kotlinytmusicscraper.extractor.Extractor
...
import pt.pulse.core.kotlinytmusicscraper.models.YouTubeClient.Companion.IOS
...
import pt.pulse.core.kotlinytmusicscraper.models.body.AccountMenuBody
import pt.pulse.core.kotlinytmusicscraper.models.body.BrowseBody
import pt.pulse.core.kotlinytmusicscraper.models.body.CreatePlaylistBody
import pt.pulse.core.kotlinytmusicscraper.models.body.EditPlaylistBody
import pt.pulse.core.kotlinytmusicscraper.models.body.FormData
import pt.pulse.core.kotlinytmusicscraper.models.body.GetQueueBody
import pt.pulse.core.kotlinytmusicscraper.models.body.GetSearchSuggestionsBody
import pt.pulse.core.kotlinytmusicscraper.models.body.LikeBody
import pt.pulse.core.kotlinytmusicscraper.models.body.SubscribeBody
import pt.pulse.core.kotlinytmusicscraper.models.body.NextBody
import pt.pulse.core.kotlinytmusicscraper.models.body.PlayerBody
import pt.pulse.core.kotlinytmusicscraper.models.body.SearchBody
...
import pt.pulse.core.kotlinytmusicscraper.utils.parseCookieString
import pt.pulse.core.kotlinytmusicscraper.utils.sha1
import pt.pulse.core.ktorext.curl.CurlLogger
import pt.pulse.core.ktorext.encoding.brotli
import pt.pulse.core.ktorext.getEngine
...
//                    },
    ...
    suspend fun checkForGithubReleaseUpdate() =
        httpClient.get("https://api.github.com/repos/hugooracle/Pulse/releases/latest") {
            contentType(ContentType.Application.Json)
        }
    ...
    companion object {
        ...
        // kept in a separate repo (pulse-files) so the main repo stays credential-free.
        const val TIDAL_REMOTE_CONFIG_URL =
            "https://raw.githubusercontent.com/hugooracle/Pulse-files/refs/heads/main/remote-config.json"
    }
}
