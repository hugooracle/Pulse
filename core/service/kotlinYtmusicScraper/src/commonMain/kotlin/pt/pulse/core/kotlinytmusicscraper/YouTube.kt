package pt.pulse.core.kotlinytmusicscraper

import com.eygraber.uri.toKmpUri
import pt.pulse.core.common.ITAG
import pt.pulse.core.kotlinytmusicscraper.YouTube.Companion.DEFAULT_VISITOR_DATA
import pt.pulse.core.kotlinytmusicscraper.extension.toListFormat
import pt.pulse.core.kotlinytmusicscraper.extractor.ExtractSource
...
import pt.pulse.core.kotlinytmusicscraper.models.ArtistItem
import pt.pulse.core.kotlinytmusicscraper.models.BrowseEndpoint
import pt.pulse.core.kotlinytmusicscraper.models.GridRenderer
import pt.pulse.core.kotlinytmusicscraper.models.MediaType
import pt.pulse.core.kotlinytmusicscraper.models.MusicCarouselShelfRenderer
...
import pt.pulse.core.kotlinytmusicscraper.models.ReturnYouTubeDislikeResponse
import pt.pulse.core.kotlinytmusicscraper.models.Run
import pt.pulse.core.kotlinytmusicscraper.models.SearchSuggestions
import pt.pulse.core.kotlinytmusicscraper.models.SongInfo
import pt.pulse.core.kotlinytmusicscraper.models.SongItem
import pt.pulse.core.kotlinytmusicscraper.models.TidalMetadataResult
import pt.pulse.core.kotlinytmusicscraper.models.VideoItem
import pt.pulse.core.kotlinytmusicscraper.models.WatchEndpoint
import pt.pulse.core.kotlinytmusicscraper.models.YTItemType
import pt.pulse.core.kotlinytmusicscraper.models.YouTubeClient
import pt.pulse.core.kotlinytmusicscraper.models.YouTubeClient.Companion.TVHTML5
import pt.pulse.core.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB
import pt.pulse.core.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB_REMIX
import pt.pulse.core.kotlinytmusicscraper.models.YouTubeLocale
import pt.pulse.core.kotlinytmusicscraper.models.getContinuation
import pt.pulse.core.kotlinytmusicscraper.models.oddElements
import pt.pulse.core.kotlinytmusicscraper.models.response.AccountMenuResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.AccountSwitcherEndpointResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.AddItemYouTubePlaylistResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.BrowseResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.CreatePlaylistResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.ImageUploadResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.DownloadProgress
import pt.pulse.core.kotlinytmusicscraper.models.response.GetQueueResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.GetSearchSuggestionsResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.LikeStatus
import pt.pulse.core.kotlinytmusicscraper.models.response.NextAndroidMusicResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.NextResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.PipedResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.PlayerResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.SearchResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.PulseChartResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.TidalSearchResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.TidalOAuthResponse
import pt.pulse.core.kotlinytmusicscraper.models.response.RemoteConfig
import pt.pulse.core.kotlinytmusicscraper.models.response.toLikeStatus
import pt.pulse.core.kotlinytmusicscraper.models.response.toListAccountInfo
import pt.pulse.core.kotlinytmusicscraper.models.pulse.FdroidResponse
import pt.pulse.core.kotlinytmusicscraper.models.pulse.GithubResponse
import pt.pulse.core.kotlinytmusicscraper.models.sponsorblock.SkipSegments
import pt.pulse.core.kotlinytmusicscraper.models.youtube.GhostResponse
import pt.pulse.core.kotlinytmusicscraper.models.youtube.Transcript
import pt.pulse.core.kotlinytmusicscraper.models.youtube.YouTubeInitialPage
import pt.pulse.core.kotlinytmusicscraper.models.youtube.tryDecodeText
import pt.pulse.core.kotlinytmusicscraper.pages.AlbumPage
import pt.pulse.core.kotlinytmusicscraper.pages.ArtistPage
import pt.pulse.core.kotlinytmusicscraper.pages.ArtistSection
import pt.pulse.core.kotlinytmusicscraper.pages.BrowseResult
import pt.pulse.core.kotlinytmusicscraper.pages.ExplorePage
import pt.pulse.core.kotlinytmusicscraper.pages.MoodAndGenres
import pt.pulse.core.kotlinytmusicscraper.pages.NextPage
import pt.pulse.core.kotlinytmusicscraper.pages.NextResult
import pt.pulse.core.kotlinytmusicscraper.pages.PlaylistContinuationPage
import pt.pulse.core.kotlinytmusicscraper.pages.PlaylistPage
import pt.pulse.core.kotlinytmusicscraper.pages.RelatedPage
import pt.pulse.core.kotlinytmusicscraper.pages.SearchPage
import pt.pulse.core.kotlinytmusicscraper.pages.SearchResult
import pt.pulse.core.kotlinytmusicscraper.pages.SearchSuggestionPage
import pt.pulse.core.kotlinytmusicscraper.parser.fromPlaylistContinuationToTracks
import pt.pulse.core.kotlinytmusicscraper.parser.fromPlaylistToTrack
import pt.pulse.core.kotlinytmusicscraper.parser.fromPlaylistToTrackWithSetVideoId
import pt.pulse.core.kotlinytmusicscraper.parser.getContinuePlaylistContinuation
import pt.pulse.core.kotlinytmusicscraper.parser.getPlaylistContinuation
import pt.pulse.core.kotlinytmusicscraper.parser.getReloadParams
import pt.pulse.core.kotlinytmusicscraper.parser.getSuggestionSongItems
import pt.pulse.core.kotlinytmusicscraper.parser.hasReloadParams
 ...
 * This library is from [z-huang/InnerTune] and I just modified it to comply with Pulse
 *
 * Here is the object that can create all request to YouTube Music and Spotify in Pulse
...
class YouTube {
     ...
     * In Pulse, I use this function to parsing Home, Playlist, Album data instead using [album], [playlist], [artist] function
...
//        }
     ...
     * if it has not been extracted yet. Diagnostic only — see [pt.pulse.core.kotlinytmusicscraper.extractor.ExtractSource].
     */
