...
import pt.pulse.core.domain.data.entities.AutoEqCurveEntity
import pt.pulse.core.domain.data.entities.AutoEqEntryEntity
import pt.pulse.core.domain.data.entities.AutoEqIndexMetaEntity
import pt.pulse.core.domain.data.entities.EpisodeEntity
import pt.pulse.core.domain.data.entities.FollowedArtistSingleAndAlbum
...
import pt.pulse.core.domain.data.entities.PodcastWithEpisodes
import pt.pulse.core.domain.data.entities.PodcastsEntity
import pt.pulse.core.domain.data.entities.QueueEntity
import pt.pulse.core.domain.data.entities.SearchHistory
...
import pt.pulse.core.domain.data.entities.YourYouTubePlaylistList
import pt.pulse.core.domain.data.entities.analytics.EventArtistEntity
import pt.pulse.core.domain.data.entities.analytics.PlaybackEventEntity
import pt.pulse.core.domain.data.entities.analytics.query.DecadeCount
import pt.pulse.core.domain.data.entities.analytics.query.PlaybackSample
...
import pt.pulse.core.domain.data.entities.analytics.query.TopPlayedArtistTime
 ...
 *
 * Kept in step with the copy in [pt.pulse.core.data.db.datasource.LocalDataSource] and with the
...
interface DatabaseDao {
     ...
     * [pt.pulse.core.data.db.datasource.LocalDataSource.insertSong], which is right when a track
