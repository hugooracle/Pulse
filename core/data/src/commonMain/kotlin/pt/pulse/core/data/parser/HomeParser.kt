...
fun Thumbnail.toThumbnail(): pt.pulse.core.domain.data.model.searchResult.songs.Thumbnail =
    pt.pulse.core.domain.data.model.searchResult.songs.Thumbnail(
        height = this.height ?: 0,
        url = this.url,
        width = this.width ?: 0,
    )

fun List<Thumbnail>.toListThumbnail(): List<pt.pulse.core.domain.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<pt.pulse.core.domain.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
