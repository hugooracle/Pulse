...
import pt.pulse.core.domain.manager.DataStoreManager.Values.PROXY_TYPE_HTTP
import pt.pulse.core.domain.manager.DataStoreManager.Values.PROXY_TYPE_SOCKS
import pt.pulse.core.domain.manager.DataStoreManager.Values.REPEAT_ALL
import pt.pulse.core.domain.manager.DataStoreManager.Values.REPEAT_MODE_OFF
import pt.pulse.core.domain.manager.DataStoreManager.Values.REPEAT_ONE
...
import pt.pulse.core.common.QUALITY as COMMON_QUALITY
...
internal class DataStoreManagerImpl(
    ...
    override val lyricsProvider =
        settingsDataStore.data.map { preferences ->
            preferences[LYRICS_PROVIDER] ?: PULSE
        }
