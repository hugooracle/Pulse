...
import pt.pulse.core.domain.data.model.mood.genre.GenreObject
import pt.pulse.core.domain.data.model.mood.genre.ItemsPlaylist
import pt.pulse.core.domain.data.model.mood.genre.ItemsSong
import pt.pulse.core.domain.data.model.mood.genre.Title
import pt.pulse.core.domain.data.model.mood.moodmoments.Content
import pt.pulse.core.domain.data.model.mood.moodmoments.Item
import pt.pulse.core.domain.data.model.mood.moodmoments.MoodsMomentObject
...
import pt.pulse.core.domain.data.model.mood.genre.Content as GenreContent
                    ...
                    if (!contents.isNullOrEmpty()) {
                        for (content in contents) {
                            if (content.musicResponsiveListItemRenderer != null) {
                                ...
                                // Pulse draws them as full-size cards. Same w120 -> w544 bump
