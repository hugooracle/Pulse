package pt.pulse.media_jvm.audio

import pt.pulse.core.domain.data.player.ReverbImpulseResponse
...
private fun reverbFolderPath(): String =
    System.getProperty("user.home") + File.separator + ".pulse" + File.separator + "reverb"
