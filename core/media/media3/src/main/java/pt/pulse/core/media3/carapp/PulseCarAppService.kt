package pt.pulse.core.media3.carapp
 ...
 */
@UnstableApi
internal class PulseCarAppService : CarAppService() {
    ...
    override fun onCreateSession(): Session = PulseCarSession()
}

@UnstableApi
internal class PulseCarSession : Session() {
    ...
    private companion object {
        private const val TAG = "PulseCarSession"
