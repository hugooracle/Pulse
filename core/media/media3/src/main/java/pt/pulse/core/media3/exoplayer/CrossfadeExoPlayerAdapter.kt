package pt.pulse.core.media3.exoplayer
...
import pt.pulse.core.media3.audio.BiquadFilter
import pt.pulse.core.media3.audio.ConvolutionReverbAudioProcessor
import pt.pulse.core.media3.audio.CrossfadeFilterAudioProcessor
import pt.pulse.core.media3.audio.EchoAudioProcessor
import pt.pulse.core.media3.audio.EqualizerAudioProcessor
import pt.pulse.core.media3.audio.EqualizerCurve
import pt.pulse.core.media3.audio.SleepFadeAudioProcessor
import pt.pulse.core.media3.exoplayer.CrossfadeExoPlayerAdapter.Companion.SPEED_PITCH_STEP
 ...
 *
 * Architecture mirrors [pt.pulse.media_jvm.GstreamerPlayerAdapter]:
                        ...
                        if (retryCount < maxRetryCount) {
                            ...
                            coroutineScope.launch {
                                try {
                                    ...
                                    streamRepository.invalidateFormat("${pt.pulse.core.common.MERGING_DATA_TYPE.VIDEO}$currentVideoId")
