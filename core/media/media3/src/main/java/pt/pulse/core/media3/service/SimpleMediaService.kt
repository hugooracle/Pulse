package pt.pulse.core.media3.service
...
import pt.pulse.core.common.MEDIA_NOTIFICATION
...
import pt.pulse.core.media3.extension.toCommandButton
...
internal class SimpleMediaService :
    MediaLibraryService(),
    KoinComponent {
    private val coroutineScope by inject<CoroutineScope>(named(pt.pulse.core.common.Config.SERVICE_SCOPE))
    ...
    private val player: Player by inject<Player>(qualifier = named(pt.pulse.core.common.Config.MAIN_PLAYER))
