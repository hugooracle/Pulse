package pt.pulse.core.media3.di
...
import pt.pulse.core.media3.cast.CastHandoffManager
import pt.pulse.core.media3.cast.CastStreamResolver
import pt.pulse.core.media3.exoplayer.CrossfadeExoPlayerAdapter
import pt.pulse.core.media3.extension.isFullyCached
import pt.pulse.core.media3.repository.CacheRepositoryImpl
import pt.pulse.core.media3.service.SimpleMediaService
import pt.pulse.core.media3.service.callback.SimpleMediaSessionCallback
import pt.pulse.core.media3.service.download.DownloadUtils
import pt.pulse.core.media3.service.mediasourcefactory.MergingMediaSourceFactory
import pt.pulse.core.media3.utils.CoilBitmapLoader
...
import pt.pulse.service.cast.initCast
import pt.pulse.service.cast.wrapWithCastPlayer
...
private val mediaServiceModule =
    module {
        ...
        // Cast support in the full build; pt.pulse.service.cast no-ops back to the same instance
