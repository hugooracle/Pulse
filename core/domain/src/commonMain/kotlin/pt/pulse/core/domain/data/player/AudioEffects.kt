 ...
 * the same reason [pt.pulse.core.domain.data.player.GenericPlaybackParameters] is: a player can tell
...
/**
 * Both audio effects as one value, which is what [pt.pulse.core.domain.mediaservice.player.MediaPlayerInterface.setAudioEffects]
 * takes.
 *
