...
/**
 * Writes a file produced by the Pulse web converter into the local database.
 *
 ...
 *
 * [pt.pulse.core.domain.utils.LocalResource.Loading] carries no payload, so it cannot say "X of Y
