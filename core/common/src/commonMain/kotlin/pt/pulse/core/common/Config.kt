...
/**
 * The YouTube stream format ids (`itag`) Pulse asks for, in one place.
 *
...
object MEDIA_NOTIFICATION {
    ...
    const val NOTIFICATION_CHANNEL_NAME = "Pulse Playback Notification"
    const val NOTIFICATION_CHANNEL_ID = "Pulse Playback Notification ID"
}
