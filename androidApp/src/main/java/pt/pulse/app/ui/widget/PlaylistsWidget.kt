package pt.pulse.app.ui.widget
...
import pt.pulse.app.MainActivity
import pt.pulse.app.R
 ...
 *
 * Tiles open `pulse://…` rather than passing extras: a widget tap often arrives with the app
        ...
        RecentlyType.Type.ALBUM ->
            (this as? AlbumEntity)?.let {
                PlaylistTile(
                    ...
                    uri = "pulse://album?id=${it.browseId}",
                )
            }
        ...
        RecentlyType.Type.ARTIST ->
            (this as? ArtistEntity)?.let {
                PlaylistTile(
                    ...
                    uri = "pulse://channel/${it.channelId}",
                )
            }
    }
