package pt.pulse.app.service.backup
...
class AutoBackupWorker(
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        try {
            ...
            // Save to Downloads/Pulse folder
    ...
    private fun saveToDownloads(backupFile: File): Boolean {
        ...
        val fileName = "pulse_backup_$timestamp.zip"
        ...
        return try {
            val contentValues = ContentValues().apply {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    put(MediaStore.Downloads.RELATIVE_PATH, "Download/Pulse")
                }
            }
            ...
            uri?.let { outputUri ->
                ...
                Logger.i(TAG, "Backup saved to Downloads/Pulse/$fileName")
                true
            } ?: false
        } catch (e: Exception) {
    ...
    private fun cleanupOldBackups(maxFiles: Int) {
        try {
            ...
            val selectionArgs = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                arrayOf("Download/Pulse/", "pulse_backup_%.zip")
            } else {
                arrayOf("pulse_backup_%.zip")
            }
            ...
            context.contentResolver.query(
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (name.startsWith("pulse_backup_") && name.endsWith(".zip")) {
