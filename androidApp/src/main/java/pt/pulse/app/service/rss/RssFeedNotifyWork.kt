package pt.pulse.app.service.rss
...
import pt.pulse.core.domain.extension.epochMillisToLocalDateTime
...
import pt.pulse.app.service.test.notification.NotificationHandler
    ...
    private fun fetchFeed(urlStr: String): String {
        val connection =
            (URL(urlStr).openConnection() as HttpURLConnection).apply {
                ...
                readTimeout = 15_000
                requestMethod = "GET"
                setRequestProperty("User-Agent", "Pulse")
            }
        return try {
